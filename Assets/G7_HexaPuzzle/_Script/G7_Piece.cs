...
public class G7_Piece : MonoBehaviour
{
    ...
    private void Start()
    {
        sprite = G7_Resources.instance.tileSprites[id];
        spriteHint = G7_Resources.instance.tileSprites[id];
    }
    ...
    public void setSpriteTiles(Sprite sprite)
    {
        if (sprite == null)
        {
            sprite = this.sprite;
    ...
    private void CompleteMoveToBoard()
    {
        ...
        print(G7_TileRegion.instance.slots);
        ...
        UpdatePiece();
        G7_TileRegion.instance.CheckPos(this);
    }
