...
public class MakeLevelController : BaseController {
    ...
    public List<Tilesss> listSlots = new List<Tilesss>();
    public List<Tilesss> listExtraTile = new List<Tilesss>();

    public bool doneGeneratePieces;

    private string piecesResult = "";
    private List<List<Tilesss>> pieces = new List<List<Tilesss>>();
    ...
    private void LoadListSlots()
    {
        ...
        {
            Tilesss tile = slot.GetComponent<Tilesss>();
			if (tile.isActive && tile.type == Tilesss.Type.Background) listSlots.Add(tile);
        }
    }
    ...
    {
        List<Tilesss> piece = new List<Tilesss>();
    ...
    private bool HasElement(Tilesss element)
    {
