...
public class Piece : MonoBehaviour {
    ...
    public List<Tilesss> matches = new List<Tilesss>();

    public List<Tilesss> tiles = new List<Tilesss>();
    public Vector2 bottomPosition;
    public Tilesss bottomBackground;
    ...
    public void FadeIn()
    {
        foreach (Tilesss tile in tiles) tile.GetComponent<Image>().canvasRenderer.SetAlpha(1);
    }
    ...
    {
        foreach(Tilesss tile in matches)
        {
